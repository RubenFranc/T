...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar país al que representa un atleta dado");
	...
	{
		System.out.println("\n" + "País al que representa un atleta dado" + "\n");
		String nombre = input("Por favor ingrese el nombre COMPLETO del atleta de interés");
		try {
			String pais = calculadora.PaisAtleta(nombre);
			System.out.println(nombre + " representó a " + pais + ".");
		}
		catch (Exception e) {
            System.out.println(nombre + " NO se encuentra en la base de datos.");
		}
